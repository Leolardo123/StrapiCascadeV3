...
export interface ApiModeradorModerador extends Struct.CollectionTypeSchema {
  collectionName: 'moderadors';
  info: {
    singularName: 'moderador';
    pluralName: 'moderadors';
